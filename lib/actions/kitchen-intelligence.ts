 ...
 * i lib/kitchen-intelligence/types.ts), til en FORHÅNDSGENERERT
 * admin-egenskap lagret direkte på oppskriften (recipes.drink_pairing) – se
 * generateDrinkPairing i lib/actions/recipes.ts og
 * lib/kitchen-intelligence/drink-pairing.ts. Denne filen har derfor ingen
 * getDrinkPairing lenger.
 */
